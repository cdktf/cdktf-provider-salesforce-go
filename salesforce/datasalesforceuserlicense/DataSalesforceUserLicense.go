...
import (
	...
	"github.com/cdktf/cdktf-provider-salesforce-go/salesforce/v8/datasalesforceuserlicense/internal"
...
func (j *jsiiProxy_DataSalesforceUserLicense) Count() interface{} {
...
func (j *jsiiProxy_DataSalesforceUserLicense)SetCount(val interface{}) {
...
func DataSalesforceUserLicense_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataSalesforceUserLicense_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataSalesforceUserLicense) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataSalesforceUserLicense) ToHclTerraform() interface{} {
	var returns interface{}
