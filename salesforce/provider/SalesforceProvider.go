...
import (
	...
	"github.com/cdktf/cdktf-provider-salesforce-go/salesforce/v8/provider/internal"
...
func SalesforceProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateSalesforceProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SalesforceProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SalesforceProvider) ToHclTerraform() interface{} {
	var returns interface{}
