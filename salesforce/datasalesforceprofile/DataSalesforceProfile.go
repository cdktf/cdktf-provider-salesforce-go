...
import (
	...
	"github.com/cdktf/cdktf-provider-salesforce-go/salesforce/v8/datasalesforceprofile/internal"
...
func DataSalesforceProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataSalesforceProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataSalesforceProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataSalesforceProfile) ToHclTerraform() interface{} {
	var returns interface{}
